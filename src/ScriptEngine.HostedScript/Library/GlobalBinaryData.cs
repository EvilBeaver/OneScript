...
namespace ScriptEngine.HostedScript.Library
{
    ...
    +Глобальный контекст, метод СоединитьДвоичныеДанные
    +Глобальный контекст, метод РазделитьДвоичныеДанные
    +Глобальный контекст, метод ПолучитьДвоичныеДанныеИзСтроки
    +Глобальный контекст, метод ПолучитьДвоичныеДанныеИзBase64Строки
    Глобальный контекст, метод ПолучитьДвоичныеДанныеИзBase64ДвоичныхДанных
    Глобальный контекст, метод ПолучитьBase64ДвоичныеДанныеИзДвоичныхДанных
    Глобальный контекст, метод ПолучитьДвоичныеДанныеИзHexСтроки
    Глобальный контекст, метод ПолучитьДвоичныеДанныеИзHexДвоичныхДанных
    Глобальный контекст, метод ПолучитьHexДвоичныеДанныеИзДвоичныхДанных
    +Глобальный контекст, метод ПолучитьДвоичныеДанныеИзБуфераДвоичныхДанных
    */
    [GlobalContext(Category = "Операции с двоичными данными")]
