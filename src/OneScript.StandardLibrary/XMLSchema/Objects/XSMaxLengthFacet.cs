...
namespace OneScript.StandardLibrary.XMLSchema.Objects
{
    ...
    public sealed class XSMaxLengthFacet : AutoContext<XSMaxLengthFacet>, IXSFacet
    {
        private readonly XmlSchemaMaxLengthFacet _facet;
        private XSAnnotation _annotation;

        private XSMaxLengthFacet() => _facet = new XmlSchemaMaxLengthFacet();
        ...
        public XSComponentType ComponentType => XSComponentType.MaxLengthFacet;
        ...
        public static XSMaxLengthFacet Constructor() => new XSMaxLengthFacet();
