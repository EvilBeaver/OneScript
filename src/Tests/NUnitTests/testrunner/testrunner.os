...
// Загружает тестовые методы из инстанса класса
Функция ОбнаружитьТестовыеСлучаи(Знач ТестОбъект, Знач ИмяКласса) Экспорт
	Возврат ПолучитьТестовыеСлучаи(ТестОбъект, ИмяКласса);
КонецФункции
