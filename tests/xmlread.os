...
Процедура ТестДолжен_ПроверитьСозданиеСПараметрами_Комментарий() Экспорт
	...
	юТест.ПроверитьРавенство(ТипыУзлов.Количество(),6);
...
Процедура ТестДолжен_ПроверитьСозданиеСПараметрами_ПробельныеСимволы1() Экспорт
	...
	юТест.ПроверитьРавенство(ТипыУзлов.Количество(),8);
	юТест.ПроверитьРавенство(ТипыУзлов[2], ТипУзлаXML.Текст);
...
Процедура ТестДолжен_ПроверитьСозданиеСПараметрами_ПробельныеСимволы2() Экспорт
	...
	юТест.ПроверитьРавенство(ТипыУзлов.Количество(),8);
	юТест.ПроверитьРавенство(ТипыУзлов[2], ТипУзлаXML.ПробельныеСимволы);
	юТест.ПроверитьРавенство(ТипыУзлов[6], ТипУзлаXML.ПробельныеСимволы);
...
Процедура ТестДолжен_ПроверитьПереключениеПробельныхСимволов() Экспорт
	...
	юТест.ПроверитьРавенство(ТипыУзлов.Количество(),7);
	юТест.ПроверитьРавенство(ТипыУзлов[1], ТипУзлаXML.Комментарий);
	юТест.ПроверитьРавенство(ТипыУзлов[2], ТипУзлаXML.ПробельныеСимволы);
