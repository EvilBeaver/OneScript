...
Процедура ТестДолжен_ПроверитьПередачуДанныхВСкриптЧерезСтандартныйПотокВвода() Экспорт
	...
	Сообщить("Тестовые данные:" + ТестовыеДанные);
	Сообщить("Вывод команды:" + ВыводКоманды);
	Сообщить("Вывод команды совпал с тестовыми данными:" + (ВыводКоманды=ТестовыеДанные));
	Сообщить("Исполняемая команда:" + ИсполняемаяКоманда);
