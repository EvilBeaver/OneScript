...
Процедура ТестДолжен_ПроверитьПолучениеКаталогаВПолномПути() Экспорт
	...
	СтрокаПутиСРазделителемВКонце = "C:\Program Files (x86)\1cv8\8.3.8.1675\bin\";
	СтрокаПутиБезРазделителяВКонце = "C:\Program Files (x86)\1cv8\8.3.8.1675\bin";
	...
	юТест.ПроверитьРавенство("C:\Program Files (x86)\1cv8\8.3.8.1675\", Файл1.Путь, "Равенство эталонному значению");
