...
Процедура ТестДолжен_ПроверитьПолучениеДатСозданияИИзменения() Экспорт	
	...
	юТест.ПроверитьРавенствоДатСТочностью2Секунды(
		ДатаСТочностьюДоСекунды(ТекущаяДата), ДатаСТочностьюДоСекунды(ВремяСоздания));
	...
	юТест.ПроверитьРавенствоДатСТочностью2Секунды(
		ДатаСТочностьюДоСекунды(ТекущаяДата), ДатаСТочностьюДоСекунды(ВремяИзменения));
