...
Процедура ТестДолженПроверитьЧтоСистемноеПеречислениеМожноПолучитьЧерезРефлектор() Экспорт
    
    Рефлектор = Новый Рефлектор;
    Свойства = Рефлектор.ПолучитьТаблицуСвойств(ДопустимыйЗнак);
    юТест.ПроверитьРавенство(2, Свойства.Количество());
