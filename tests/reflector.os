...
Процедура ТестДолжен_ПроверитьПриватныеПоля() Экспорт
	...
	ТаблицаМетодов = Рефлектор.ПолучитьТаблицуМетодов(Пример);
	юТест.ПроверитьРавенство(ТаблицаМетодов[4].Имя, "ПриватнаяПроцедура");
	юТест.ПроверитьРавенство(ТаблицаМетодов[4].Экспорт, Ложь);
	юТест.ПроверитьРавенство(ТаблицаМетодов[6].Имя, "Яшма2");
	юТест.ПроверитьРавенство(ТаблицаМетодов[6].Экспорт, Истина);
	...
	ТаблицаМетодов = Рефлектор.ПолучитьТаблицуМетодов(ТипЗнч(Пример));
	юТест.ПроверитьРавенство(ТаблицаМетодов[3].Имя, "ПриватнаяПроцедура");
	юТест.ПроверитьРавенство(ТаблицаМетодов[3].Экспорт, Ложь);
	юТест.ПроверитьРавенство(ТаблицаМетодов[5].Имя, "Яшма2");
	юТест.ПроверитьРавенство(ТаблицаМетодов[5].Экспорт, Истина);
