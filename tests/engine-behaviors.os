...
Процедура ТестДолжен_ПроверитьЧтоСтандартныйПотокВводаЭтоПотокВПамяти() Экспорт
	...
	юТест.ПроверитьРавенство(ТипЗнч(СтандартныйПотокВвода), Тип("ПотокВПамяти"), "Стандартный поток ввода - поток в памяти");
...
Процедура ТестДолжен_ПроверитьПередачуДанныхВСкриптЧерезСтандартныйПотокВвода() Экспорт
	...
	юТест.ПроверитьРавенство(ВыводКоманды, "12345", "Вывод команды - тестовые данные");
