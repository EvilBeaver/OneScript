...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ПроверитьЧтоСтандартныйПотокВводаЭтоПотокВПамяти");
...
Процедура ТестДолжен_ПроверитьЧтоСтандартныйПотокВводаЭтоПотокВПамяти() Экспорт

	Консоль = Новый Консоль();
	
	юТест.ПроверитьРавенство(ТипЗнч(Консоль.ПолучитьСтандартныйПотокВвода()), Тип("ПотокВПамяти"), "Стандартный поток ввода - поток в памяти");
...
Процедура ТестДолжен_ПроверитьПередачуДанныхВСкриптЧерезСтандартныйПотокВвода() Экспорт
	...
	КодСкрипта = "Консоль = Новый Консоль();
	             |
	             |Чтение = Новый ЧтениеТекста();
	             |Чтение.Открыть(Консоль.ПолучитьСтандартныйПотокВвода());
