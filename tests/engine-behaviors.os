...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ПроверитьОшибкиСравненияНаБольшеМеньше");
...
Процедура ТестДолжен_ПроверитьОшибкиСравненияНаБольшеМеньше() Экспорт
	...
	Ошибка = "Сравнение на больше/меньше типов 'ПеречислениеХешФункция' и 'ПеречислениеСтатусСообщения' не поддерживается";	
	юТест.ПроверитьКодСОшибкой(
