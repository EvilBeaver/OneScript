...
Процедура ТестДолжен_ПроверитьФорматированиеПредставлениеОтрицательных() Экспорт
	...
	юТест.ПроверитьРавенство("(123234,811)", Формат(Число, "ЧО=0; ЧГ=0"));
	юТест.ПроверитьРавенство("-123 234,811", Формат(Число, "ЧО=1"));
	юТест.ПроверитьРавенство("- 123 234,811", Формат(Число, "ЧО=2"));
	юТест.ПроверитьРавенство("123 234,811-", Формат(Число, "ЧО=3"));
	юТест.ПроверитьРавенство("123 234,811 -", Формат(Число, "ЧО=4"));
