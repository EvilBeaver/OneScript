...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ПроверитьПолучениеАннотацийСпискаПеременных");
...
Процедура ТестДолжен_ПроверитьАннотациюКакЗначениеПараметраАннотации() Экспорт
	...
	юТест.ПроверитьТип(ПервыйПараметрПервойАннотации.Значение, Тип("СтрокаТаблицыЗначений"));
	
	юТест.ПроверитьРавенство(ПервыйПараметрПервойАннотации.Значение.Имя, "ТожеАннотация");
	юТест.ПроверитьТип(ПервыйПараметрПервойАннотации.Значение.Параметры, Тип("ТаблицаЗначений"));
	
	юТест.ПроверитьТип(ПервыйПараметрПервойАннотации.Значение.Параметры[0].Значение, Тип("СтрокаТаблицыЗначений"));
	юТест.ПроверитьРавенство(ПервыйПараметрПервойАннотации.Значение.Параметры[0].Значение.Имя, "СТожеПараметромАннотацией");
	
	юТест.ПроверитьРавенство(ПервыйПараметрПервойАннотации.Значение.Параметры[1].Имя, "П2");
	юТест.ПроверитьРавенство(ПервыйПараметрПервойАннотации.Значение.Параметры[1].Значение.Имя, "СТожеПараметромАннотацией");
...
Процедура ТестДолжен_ПроверитьПолучениеАннотацийСпискаПеременных() Экспорт

	ТекстСценария = "&Аннотация1
	|Перем Поле1 Экспорт, Поле2;
	|Перем Поле3;
	|";
	...
	Рефлектор = Новый Рефлектор;
	ТаблицаСвойств = Рефлектор.ПолучитьТаблицуСвойств(Сценарий, Истина);

	юТест.ПроверитьРавенство(ТаблицаСвойств.Количество(),  3, "Ожидали, что в таблице свойств будет 3 свойства");
	
	юТест.ПроверитьРавенство(ТаблицаСвойств[0].Аннотации.Количество(),  1, "Ожидали, что Поле1 имеет 1 аннотацию");
	ИмяАннотации = ТаблицаСвойств[0].Аннотации[0].Имя;
	юТест.ПроверитьРавенство(ИмяАннотации,  "Аннотация1", "Ожидали, что Поле1 имеет аннотацию Аннотация1");
	
	юТест.ПроверитьРавенство(ТаблицаСвойств[1].Аннотации.Количество(),  1, "Ожидали, что Поле2 имеет 1 аннотацию");
	ИмяАннотации = ТаблицаСвойств[1].Аннотации[0].Имя;
	юТест.ПроверитьРавенство(ИмяАннотации,  "Аннотация1", "Ожидали, что Поле2 имеет аннотацию Аннотация1");
	
	юТест.ПроверитьРавенство(ТаблицаСвойств[2].Аннотации.Количество(),  0, "Ожидали, что Поле3 не имеет аннотаций");
