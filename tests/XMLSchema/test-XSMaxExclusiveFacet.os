...
Процедура ТестКонструктор() Экспорт
	...
	Фасет = Новый ФасетМаксимальногоИсключающегоЗначенияXS;
	
	ЮнитТест.ПроверитьРавенство(ТипЗнч(Фасет), Тип("ФасетМаксимальногоИсключающегоЗначенияXS"));
	ЮнитТест.ПроверитьРавенство(Фасет.ТипКомпоненты, ТипКомпонентыXS.МаксимальноИсключающийФасет);
...
Процедура TestConstructor() Экспорт
	...
	Facet = New XSMaxExclusiveFacet;
	
	ЮнитТест.ПроверитьРавенство(ТипЗнч(Facet), Тип("XSMaxExclusiveFacet"));
	ЮнитТест.ПроверитьРавенство(Facet.ComponentType, XSComponentType.MaxExclusiveFacet);
