...
Процедура ЗавершитьЗаписьВФайлОтчетаТестированияВФорматеJUnitXML(ЗаписьXML, ДатаНачала)
	...
	Для Сч = 0 По НаборТестов.Количество() - 1 Цикл
		...
		ЗаписьXML.ЗаписатьАтрибут("name", СтрЗаменить(ОписаниеТеста.ПолноеИмя, ТекущийКаталог()+"\", ""));
		ЗаписьXML.ЗаписатьНачалоЭлемента("properties");	
		ЗаписьXML.ЗаписатьКонецЭлемента();

		ЗаполнитьРезультатТестовогоСлучая(ЗаписьXML, ОписаниеТеста, НаборОшибок);
...
Процедура ЗаполнитьРезультатТестовогоСлучая(ЗаписьXML, ОписаниеТеста, НаборОшибок)
		
	ЗаписьXML.ЗаписатьНачалоЭлемента("testcase");
	ЗаписьXML.ЗаписатьАтрибут("classname", СтрЗаменить(ОписаниеТеста.ПолноеИмя, ТекущийКаталог()+"\", ""));
