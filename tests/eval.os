...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ПроверитьРекурсивныйВызов");
	ВсеТесты.Добавить("ТестДолжен_ПроверитьСложныеВложенныеВызовы");
	ВсеТесты.Добавить("ТестДолжен_ПроверитьВычислитьВнутриВыполнить");
	ВсеТесты.Добавить("ТестДолжен_ПроверитьАлиасыФункцийИПеременных");
...
Процедура ТестДолжен_ПроверитьРекурсивныйВызов() Экспорт
	Рез = "Вычислить(1)";
	Для й=1 По 100 Цикл
	  Рез = "Вычислить("+Рез+")+1";
	КонецЦикла;
...
Процедура ТестДолжен_ПроверитьСложныеВложенныеВызовы() Экспорт
	Глобал = 0;
	Рез = Вычислить("Ответ()");	
...
Процедура ТестДолжен_ПроверитьАлиасыФункцийИПеременных() Экспорт
