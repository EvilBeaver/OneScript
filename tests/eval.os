...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ПроверитьПроверитьРекурсивныйВызовВыполнить");
	ВсеТесты.Добавить("ТестДолжен_ПроверитьПроверитьВложенныеВызовыВыполнить");	
	ВсеТесты.Добавить("ТестДолжен_ПроверитьПроверитьВызовыВыполнитьСПопытками");
...
Процедура ТестДолжен_ПроверитьПроверитьРекурсивныйВызовВыполнить() Экспорт
...
Процедура ТестДолжен_ПроверитьПроверитьВложенныеВызовыВыполнить() Экспорт
...
Процедура ТестДолжен_ПроверитьПроверитьВызовыВыполнитьСПопытками() Экспорт
