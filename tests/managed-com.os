...
Процедура ТестДолжен_ПроверитьРаботуТипаНеИзЯдра() Экспорт
	...
	ПодключитьВнешнююКомпоненту("component/Component.dll");
	ПростоКласс = Новый COMОбъект("component.SimpleClass"); // доступность класса из произвольной подключенной сборки

	ПростоКласс.AnyValueProperty = 1;
	юТест.ПроверитьРавенство(ПростоКласс.AnyValueProperty, 1);

	ПростоКласс.AnyValueProperty = "текст";
	юТест.ПроверитьРавенство(ПростоКласс.AnyValueProperty, "текст");
	
	ПростоКласс.AnyValueProperty = '20171019';
	юТест.ПроверитьРавенство(ПростоКласс.AnyValueProperty, '20171019');
