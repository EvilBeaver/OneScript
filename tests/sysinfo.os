...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ПолучитьПолнуюКоманднуюСтроку");
...
Процедура ТестДолжен_ПолучитьПолнуюКоманднуюСтроку() Экспорт
    Си = Новый СистемнаяИнформация();
    юТест.ПроверитьИстину(СтрНайти(Си.ПолнаяКоманднаяСтрока, "testrunner.os") > 1);
КонецПроцедуры