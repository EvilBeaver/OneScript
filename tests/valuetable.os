...
Процедура ТестДолжен_ВыгрузитьКолонкуВМассив() Экспорт
	...
	юТест.ПроверитьИстину(ПроверитьИдентичностьМассивов(Т.ВыгрузитьКолонку("Ключ"), ЭталонКлючей), "Массивы ключей должны совпадать");
	юТест.ПроверитьИстину(ПроверитьИдентичностьМассивов(Т.ВыгрузитьКолонку("Значение"), ЭталонЗначений), "Массивы значений должны совпадать");
	
КонецПроцедуры

Функция ПроверитьИдентичностьМассивов(Знач Проверяемый, Знач Эталон)
