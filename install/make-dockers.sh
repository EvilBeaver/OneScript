...
docker run -v $THISDIR/../src/ScriptEngine.NativeApi:/build/src oscript/onescript-builder:gcc pwd
docker run -v $THISDIR/../src/ScriptEngine.NativeApi:/build/src oscript/onescript-builder:gcc ls
