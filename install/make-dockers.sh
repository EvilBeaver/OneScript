...
docker run -v $(pwd):/build/src oscript/onescript-builder:gcc pwd
docker run -v $(pwd):/build/src oscript/onescript-builder:gcc sh ls && pwd
docker run -v $(pwd):/build/src oscript/onescript-builder:gcc sh ./build.sh
