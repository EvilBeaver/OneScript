...
* У всех элементов, поддерживающих модификатор доступа, он должен быть указан явно. В качестве исключения допускается не указывать модификатор доступа «internal» у класса;
...
* Области #region…#endregion должны использоваться только в крайних случаях. Длинные методы, классы и т.д., требующие свертки кода – признак некачественного дизайна.
